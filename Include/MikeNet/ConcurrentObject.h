...
public:
	...
	*/
	 ...
	 */
	void ConcurrentObject::BitOn(size_t bitNumber)
	{
	 ...
	 */
	void ConcurrentObject::BitOff(size_t bitNumber)
	{
	 ...
	 */
	void ConcurrentObject::BitToggle(size_t bitNumber)
	{
	 ...
	 */
	bool ConcurrentObject::BitGet(size_t bitNumber) const
	{
	...
	static bool TestClass()
	{
...

		{
			...
			{
				threads.Add(new ThreadSingle(&ConcurrentObjectTestFunction,&co,false));
			}
