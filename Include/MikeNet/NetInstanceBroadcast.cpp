 ...
 */
NetInstanceBroadcast::NetInstanceBroadcast(const NetAddress * p_broadcastAddress, NetSocketUDP * p_socketUDP, unsigned int p_sendTimeout, size_t p_instanceID)  :
 ...
 */
NetInstanceBroadcast::NetInstanceBroadcast(const NetAddress * p_broadcastAddress, const NetInstanceProfile & p_profile, size_t p_instanceID) : 
...
bool NetInstanceBroadcast::TestClass()
{
	...
	NetInstanceBroadcast broadcastSend(&broadcastAddress,new NetSocketUDP(1024,localAddrSend));

	NetAddress localAddrRecv(NULL,6000);
	NetInstanceBroadcast broadcastRecv(NULL,new NetSocketUDP(1024,localAddrRecv));
