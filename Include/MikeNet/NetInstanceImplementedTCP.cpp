...
{
	return socketTCP->GetMode()->GetPartialPacketCurrentSize();
}
...
void NetInstanceImplementedTCP::SetMaxPacketSizeTCP(size_t newMaxSize, size_t clientID)
{
	...
	socketTCP->GetMode()->ChangeMaxPacketSize(newMaxSize);
}
...
{
	return socketTCP->GetMode()->GetAutoResize();
}
...
/**
 * @brief	Techlord Modification for TCP_FOR_HTTP Mode. Enable/Disables TCP mode Prefix/Postfix.
 */
void NetInstanceImplementedTCP::SetAffixEnableTCP(size_t clientID, bool enabledflag)
{
	socketTCP->GetMode()->SetAffixEnable(enabledflag);
}

/**
 * @brief	Techlord Modification for TCP_FOR_HTTP Mode. Retrieve HTTP Affix Enabled Flag.
 */
bool NetInstanceImplementedTCP::GetAffixEnableTCP(size_t clientID)
{
	return socketTCP->GetMode()->GetAffixEnable();
}

/**
 * @brief	Techlord Modification for TCP_FOR_HTTP Mode.
 */
void NetInstanceImplementedTCP::SetBinaryModeTCP(size_t clientID, bool enabledflag)
{
	socketTCP->GetMode()->SetBinaryMode(enabledflag);
}

/**
 * @brief	Techlord Modification for TCP_FOR_HTTP Mode. 
 */
bool NetInstanceImplementedTCP::GetBinaryModeTCP(size_t clientID)
{
	return socketTCP->GetMode()->GetBinaryMode();
}

/**
 * @brief	Techlord Modification for TCP_FOR_HTTP Mode.
 */
void NetInstanceImplementedTCP::SetHeaderFoundTCP(size_t clientID, bool foundflag)
{
	socketTCP->GetMode()->SetHeaderFound(foundflag);
}

/**
 * @brief	Techlord Modification for TCP_FOR_HTTP Mode. 
 */
bool NetInstanceImplementedTCP::GetHeaderFoundTCP(size_t clientID)
{
	return socketTCP->GetMode()->GetHeaderFound();
}