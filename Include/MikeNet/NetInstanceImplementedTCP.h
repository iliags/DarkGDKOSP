...
public:
	...
	virtual void SetAffixEnableTCP(size_t clientID, bool enabledflag=true); //Techlord Modification for TCP_FOR_HTTP Mode.

	virtual bool GetAffixEnableTCP(size_t clientID); //Techlord Modification for TCP_FOR_HTTP Mode.

	virtual void SetBinaryModeTCP(size_t clientID, bool enabledflag=false); //Techlord Modification for TCP_FOR_HTTP Mode.

	virtual bool GetBinaryModeTCP(size_t clientID); //Techlord Modification for TCP_FOR_HTTP Mode.

	virtual void SetHeaderFoundTCP(size_t clientID, bool foundflag=true); //Techlord Modification for TCP_FOR_HTTP Mode.

	virtual bool GetHeaderFoundTCP(size_t clientID); //Techlord Modification for TCP_FOR_HTTP Mode
