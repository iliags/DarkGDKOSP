...
public:
	...
	void Initialize(size_t maxClients,bool handshakeEnabled, size_t connectionTimeout, NetSocketListening * socketListening);	
	~NetInstanceServer();
...
public:
	...
	void SetAffixEnableTCP(size_t clientID, bool enabledflag=true); //Techlord Modification
	bool GetAffixEnableTCP(size_t clientID); //Techlord Modification

	void SetBinaryModeTCP(size_t clientID, bool enabledflag=false); //Techlord Modification
	bool GetBinaryModeTCP(size_t clientID); //Techlord Modification

	void SetHeaderFoundTCP(size_t clientID, bool foundflag=false); //Techlord Modification
	bool GetHeaderFoundTCP(size_t clientID); //Techlord Modification
