...
public:
	 ...
	 * @param clientID ID of client to use, may be ignored.
	 *
	 * @param enabledflag, Affix flag toggle.
	 */
	virtual void SetAffixEnableTCP(size_t clientID, bool enabledflag)= 0;
	 ...
	 * @param clientID ID of client to use, may be ignored.
	 */
	virtual bool GetAffixEnableTCP(size_t clientID)= 0;


	/**
	 * @brief Techlord Modification for TCP_FOR_HTTP Mode. Enable/Disable the HTTP Binary Mode Flag.
	 */
	virtual void SetBinaryModeTCP(size_t clientID, bool foundflag)= 0;
	...
	* @param clientID ID of client to use, may be ignored.
	*/
	virtual bool GetBinaryModeTCP(size_t clientID)= 0;

	/**
	 * @brief Techlord Modification. Set Header Found Flag.
	 */
	virtual void SetHeaderFoundTCP(size_t clientID, bool foundflag)= 0;
	...
	* @param clientID ID of client to use, may be ignored.
	*/
	virtual bool GetHeaderFoundTCP(size_t clientID)= 0;
