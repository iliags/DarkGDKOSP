...
public:
	...
	enum ProtocolMode
	{
		...
		/**
		 * A postfix which can consist of any data is optionally appended to the end of all packets being sent.
		 * Packets being received are expected to optionally have this postfix.
		 * The postfix indicates the end of the packet and is not included as part of received packets.\n\n
		 *
		 * Packets received are put into a queue and none are discarded.\n\n
		 *
