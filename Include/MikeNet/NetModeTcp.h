...
protected:
	...
	/**
	 * @brief //Techlord Modification for TCP_FOR_HTTP Mode. Stores Boolean flag to enable/disable using postfix.
	 */
	bool affixenabledflag;
	bool binarymodeflag;
	bool headerfoundflag;
...
public:
	 ...
	 * @param	enabledflag.
	 */
	virtual void SetAffixEnable(bool enabledflag)= 0;

	/**
	 * @brief	Techlord Modification for TCP_FOR_HTTP Mode. Returns Affix Flag Value.
	 */
	virtual bool GetAffixEnable(void)= 0;
	 ...
	 * @param	enabledflag.
	 */
	virtual void SetBinaryMode(bool enabledflag)= 0;

	/**
	 * @brief	Techlord Modification for TCP_FOR_HTTP Mode. Returns Affix Flag Value.
	 */
	virtual bool GetBinaryMode(void)= 0;
	 ...
	 * @param	foundflag.
	 */
	virtual void SetHeaderFound(bool foundflag)= 0;

	/**
	 * @brief	Techlord Modification for TCP_FOR_HTTP Mode. Returns Affix Flag Value.
	 */
	virtual bool GetHeaderFound(void)= 0;	
