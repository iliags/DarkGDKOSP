...
bool NetModeTcpPostfix::TestClass()
{
	...
	Packet postfix("\r\n");
	NetModeTcpPostfix obj(1024,true,postfix);
...
/**
 * @brief Techlord Modification for TCP_FOR_HTTP Mode. Enable/Disable the postfix in use, which indicates the end of a packet.
 *
 * @return the postfix in use.
 */
void NetModeTcpPostfix::SetAffixEnable(bool enabledflag)
{
 ...
 * @return the postfix in use.
 */
bool NetModeTcpPostfix::GetAffixEnable()
{
 ...
 */
void NetModeTcpPostfix::SetBinaryMode(bool enabledflag)
{
 ...
 * @return the prefix in use.
 */
bool NetModeTcpPostfix::GetBinaryMode()
{
 ...
 * @return the prefix in use.
 */
void NetModeTcpPostfix::SetHeaderFound(bool foundflag)
{
 ...
 * @return the prefix in use.
 */
bool NetModeTcpPostfix::GetHeaderFound()
{
