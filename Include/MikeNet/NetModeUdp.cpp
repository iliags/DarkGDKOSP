 ...
 */
NetModeUdp * NetModeUdp::GenerateModeUDP(NetMode::ProtocolMode protocolMode, size_t numClients, size_t numOperations, size_t recvSize, const EncryptKey * decryptKey)
{
	NetModeUdp * returnMe;
...
bool NetModeUdp::TestClass()
{
	...
	NetModeUdp * mode = GenerateModeUDP(NetMode::UDP_PER_CLIENT_PER_OPERATION,50,5,1024,NULL);
