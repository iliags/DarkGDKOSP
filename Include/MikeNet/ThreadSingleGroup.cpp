...
bool ThreadSingleGroup::TestClass()
{
	...
	size_t speed = 0;
	{
		...
		ThreadSingle * thread1 = new (nothrow) ThreadSingle(&ThreadSingleGroupTestFunction,(void*)5000,false);
		ThreadSingle * thread2 = new (nothrow) ThreadSingle(&ThreadSingleGroupTestFunction,(void*)3000,false);
		ThreadSingle * thread3 = new (nothrow) ThreadSingle(&ThreadSingleGroupTestFunction,(void*)4000,false);
		group.Add(thread1);
		group.Add(thread2);
		group.Add(thread3);
