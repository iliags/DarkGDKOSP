 ...
 * @param	block				If true this command will block until @a timeoutMilliseconds has expired or the connection process has completed. \n
 * If false this command will return instantly and mn::PollConnect should be used on the instance to poll on the connection process and determine its success/failure.
 * @param	profile				Pointer (cast to __int64) to instance profile containing additional instance settings.
 *
 * @return	if block is true: \n
 * @return NetUtility::CONNECTED if the handshaking process completed successfully and the client is now fully connected.
 * @return NetUtility::TIMED_OUT if the handshaking process timed out.
 ...
 * @return NetUtility::CONNECTION_ERROR if an error occurred.
 */
DBP_CPP_DLL NetUtility::ConnectionStatus mn::Connect(size_t instanceID, const char * connectIP_TCP, unsigned short connectPort_TCP, const char * connectIP_UDP, unsigned short connectPort_UDP, size_t timeoutMilliseconds, bool block, __int64 profile)
{
	NetUtility::ConnectionStatus returnMe = NetUtility::CONNECTION_ERROR;
	const char * cCommand = "mn::Connect";
 ...
 */
DBP_CPP_DLL int mn::StartServer(size_t instanceID, size_t maxClients, __int64 profile)
{
	int returnMe = -1;
	const char * cCommand = "mn::StartServer";
...
int mn::StartBroadcast(size_t instanceID, const NetAddress & connectAddress, bool sendEnabled, bool recvEnabled, const NetInstanceProfile & profile)
{
	...
	{
		// Create instance and add it to group
		NetInstance * newInstance = new (nothrow) NetInstanceBroadcast(&connectAddress,profile,instanceID);
		Utility::DynamicAllocCheck(newInstance,__LINE__,__FILE__);
 ...
 * @return -1 if the instance failed to start.
 */
DBP_CPP_DLL int mn::StartBroadcast(size_t instanceID, const char * connectAddressIP, unsigned short connectAddressPort, bool sendEnabled, bool recvEnabled, __int64 profile)
{
	int returnMe = -1;
	const char * cCommand = "mn::StartBroadcast";
 ...
 */
DBP_CPP_DLL int mn::SetProfileServerTimeout(__int64 profile, size_t timeoutMilliseconds)
{
	int returnMe = -1;
	const char * cCommand = "mn::SetProfileServerTimeout";
 ...
 */
DBP_CPP_DLL size_t mn::GetProfileServerTimeout(__int64 profile)
{
	size_t returnMe = 0;
	const char * cCommand = "mn::GetProfileServerTimeout";
 ...
 */
DBP_CPP_DLL size_t mn::GetClientFrom(__int64 packet)
{
	size_t returnMe = 0;
 ...
 */
DBP_CPP_DLL int mn::SetProfileBufferSizes(__int64 profile, size_t recvSizeTCP, size_t recvSizeUDP)
{
	int returnMe = -1;
	const char * cCommand = "mn::SetProfileBufferSizes";
 ...
 */
DBP_CPP_DLL int mn::SetProfileEnabledUDP(__int64 profile, bool option)
{
	int returnMe = -1;
	const char * cCommand = "mn::SetProfileEnabledUDP";
 ...
 * instead of throwing an error or forcefully disconnecting that client, the. 
 * TCP receive buffer automatically resizes to allow for the TCP packet to be
 * received.
 *
 * @param	instanceID	Unique identifier for instance.
 * @param	clientID	ID of client.
 ...
 * @brief Changes the auto resize TCP option.
 *
 * @copybrief mn::SetProfileAutoResizeTCP(NetInstanceProfile&, bool)
 */ 
DBP_CPP_DLL int mn::SetProfileAutoResizeTCP(__int64 profile, bool autoResize)
{
	int returnMe = -1;
	const char * cCommand = "mn::SetProfileAutoResizeTCP";
 ...
 */
DBP_CPP_DLL int mn::SetProfileHandshakeEnabled(__int64 profile, bool option)
{
	int returnMe = -1;
	const char * cCommand = "mn::SetProfileHandshakeEnabled";
 ...
 */
DBP_CPP_DLL int mn::SetProfileModeTCP(__int64 profile, char modeTCP)
{
	int returnMe = -1;
	const char * cCommand = "mn::SetProfileModeTCP";
 ...
 *
 * @param [out]	profile		Instance profile to be modified.
 * @param		modeUDP		UDP mode option. Default is NetInstanceProfile::DEFAULT_MODE_TCP.
 *
 * @return  0 if the command completed successfully.
 * @return	-1 if an error occurred.
 ...
 */
DBP_CPP_DLL int mn::SetProfileModeUDP( __int64 profile, char modeUDP )
{
	int returnMe = -1;
	const char * cCommand = "mn::SetProfileModeUDP";
 ...
 */
DBP_CPP_DLL int mn::SetProfileGracefulDisconnectEnabled(__int64 profile, bool option)
{
	int returnMe = -1;
	const char * cCommand = "mn::SetProfileGracefulDisconnectEnabled";
 ...
 */
DBP_CPP_DLL int mn::SetProfileSendTimeout(__int64 profile, unsigned int timeoutMilliseconds)
{
	int returnMe = -1;
	const char * cCommand = "mn::SetProfileSendTimeout";
 ...
 * @return	-1 if an error occurred.
 */
DBP_CPP_DLL int mn::SetProfilePostfixTCP(__int64 profile, __int64 packet)
{
	int returnMe = -1;
 ...
 * @brief This command changes the postfix option of the specified instance profile.
 *
 * @copydetails mn::SetProfilePostfixTCP(__int64, __int64)
 */
 ...
 */
int mn::SetProfileNagleEnabledTCP(__int64 profile, bool option)
{
	int returnMe = -1;
	const char * cCommand = "mn::SetProfileNagleEnabledTCP";
 ...
 */
DBP_CPP_DLL bool mn::GetConnecting(size_t instanceID)
{
	bool returnMe = false;
	const char * cCommand = "mn::PollConnect";
 ...
 * @return -1 if an error occurred.
 */
DBP_CPP_DLL int mn::GetPostfixTCP(size_t instanceID, __int64 packet)
{
	int returnMe = 0;
 ...
 * @brief Retrieves the TCP postfix in use.
 *
 * @copydetails mn::GetPostfixTCP(size_t,__int64)
 */
 ...
 */
DBP_CPP_DLL size_t mn::RecvTCP(size_t instanceID, __int64 destinationPacket, size_t clientID)
{
	size_t returnMe = 0;
	const char * cCommand = "mn::RecvTCP";
 ...
 */
DBP_CPP_DLL size_t mn::RecvUDP(size_t instanceID, __int64 destinationPacket, size_t clientID, size_t operationID)
{	
	size_t returnMe = 0;
	const char * cCommand = "mn::RecvUDP";
 ...
 */
DBP_CPP_DLL int mn::SendUDP(size_t instanceID, __int64 packet, size_t clientID, bool keep, bool block)
{
 ...
 * @return NetUtility::SEND_FAILED_KILL if the send operation failed and an entity was killed as a result (e.g. Client disconnected).
 */
DBP_CPP_DLL int mn::SendToUDP(size_t instanceID, __int64 packet, const char * addrIP, unsigned short addrPort, bool keep, bool block)
{
	int returnMe = -1; 
	const char * cCommand = "mn::SendToUDP";
 ...
 */
DBP_CPP_DLL int mn::SendTCP(size_t instanceID, __int64 packet, size_t clientID, bool keep, bool block)
{
	int returnMe = -1;
	const char * cCommand = "mn::SendTCP";
 ...
 */
DBP_CPP_DLL int mn::SendAllTCP(size_t instanceID, __int64 packet, bool keep, bool block, size_t clientExcludeID)
{
	int returnMe = 0;
	const char * cCommand = "mn::SendAllTCP";
 ...
 */
DBP_CPP_DLL int mn::SendAllUDP(size_t instanceID, __int64 packet, bool keep, bool block, size_t clientExcludeID)
{
	int returnMe = 0;
	const char * cCommand = "mn::SendAllUDP";
 ...
 */
CPP_DLL const char * mn::GetProfileLocalIPTCP(__int64 profile)
{
	const char * returnMe = "";
 ...
 */
DBP_CPP_DLL unsigned short mn::GetProfileLocalPortTCP(__int64 profile)
{
	unsigned short returnMe = 0;
 ...
 */
CPP_DLL const char * mn::GetProfileLocalIPUDP(__int64 profile)
{
	const char * returnMe = "";
 ...
 */
DBP_CPP_DLL unsigned short mn::GetProfileLocalPortUDP(__int64 profile)
{
	unsigned short returnMe = 0;
 ...
 * @return	-1 if an error occurred. 
 */
DBP_CPP_DLL int mn::SetProfileLocalTCP(__int64 profile, const char * IP, unsigned short port)
{
	int returnMe = -1;
	const char * cCommand = "mn::SetProfileLocalTCP";
 ...
 * @return	-1 if an error occurred. 
 */
DBP_CPP_DLL int mn::SetProfileLocalUDP(__int64 profile, const char * IP, unsigned short port)
{
	int returnMe = -1;
	const char * cCommand = "mn::SetProfileLocalUDP";
 ...
 * @return	-1 if an error occurred. 
 */
DBP_CPP_DLL int mn::SetProfileLocal(__int64 profile, const char * IP_TCP, unsigned short portTCP, const char * IP_UDP, unsigned short portUDP)
{
	int returnMe = -1;
	const char * cCommand = "mn::SetProfileLocal";
 ...
 * See @ref multithreadingPage "multithreaded usage" for more information.
 *
 ...
 */
size_t mn::GetProfileBufferSizeTCP( __int64 profile )
{
	size_t returnMe = 0;
	const char * cCommand = "mn::GetProfileBufferSizeTCP";
 ...
 */
size_t mn::GetProfileBufferSizeUDP( __int64 profile )
{
	size_t returnMe = 0;
	const char * cCommand = "mn::GetProfileBufferSizeUDP";
 ...
 */
DBP_CPP_DLL int mn::GetProfileEnabledUDP( __int64 profile )
{
	int returnMe = -1;
	const char * cCommand = "mn::GetProfileEnabledUDP";
 ...
 */
DBP_CPP_DLL	int mn::GetProfileAutoResizeTCP( __int64 profile )
{
	int returnMe = -1;
	const char * cCommand = "mn::GetProfileAutoResizeTCP";
 ...
 */
DBP_CPP_DLL	int mn::GetProfileHandshakeEnabled( __int64 profile )
{
	int returnMe = -1;
	const char * cCommand = "mn::GetProfileFunctionTCP";
 ...
 */
DBP_CPP_DLL	NetMode::ProtocolMode mn::GetProfileModeTCP( __int64 profile )
{
	NetMode::ProtocolMode returnMe;
	const char * cCommand = "mn::GetProfileFunctionTCP";
 ...
 */
DBP_CPP_DLL	NetMode::ProtocolMode mn::GetProfileModeUDP( __int64 profile )
{
	NetMode::ProtocolMode returnMe;
	const char * cCommand = "mn::GetProfileFunctionUDP";
 ...
 */
DBP_CPP_DLL	int mn::GetProfileGracefulDisconnectEnabled( __int64 profile )
{
	int returnMe = -1;
	const char * cCommand = "mn::GetProfileFunctionTCP";
 ...
 */
DBP_CPP_DLL size_t mn::GetProfileSendTimeout( __int64 profile )
{
	size_t returnMe = 0;
	const char * cCommand = "mn::GetProfileFunctionTCP";
 ...
 * @return	-1 if an error occurred.
 */
DBP_CPP_DLL	int mn::GetProfilePostfixTCP( __int64 profile, __int64 destination )
{
	int returnMe = 0;
	const char * cCommand = "mn::GetProfileFunctionTCP";
 ...
 */
DBP_CPP_DLL	int mn::GetProfileNagleEnabledTCP( __int64 profile )
{
	int returnMe = -1;
	const char * cCommand = "mn::GetProfileFunctionTCP";
 ...
 */
__int64 mn::CreateInstanceProfile()
{
 ...
 * @return	-1 if an error occurred.
 */
int mn::DeleteInstanceProfile(__int64 profile)
{
 ...
 */
__int64 mn::CreateInstanceProfileFrom(__int64 profile)
{
 ...
 * @return @a dest.
 */
__int64 mn::AssignInstanceProfile(__int64 dest, __int64 source)
{
 ...
 * @return -1 if an error occurred.
 */
int mn::CompareInstanceProfile(__int64 profile1, __int64 profile2)
{
 ...
 * @return	-1 if an error occurred.
 */
DBP_CPP_DLL int mn::AddUnsignedInt(__int64 packet, unsigned int add)
{
	int returnMe = 0; 
 ...
 */
DBP_CPP_DLL int mn::AddInt(__int64 packet, int add)
{
	int returnMe = 0;
 ...
 * @copydoc mn::AddUnsignedInt()
 */
CPP_DLL int mn::AddLongInt(__int64 packet, long int add)
{
	int returnMe = 0; 
 ...
 * @copydoc mn::AddUnsignedInt()
 */
DBP_CPP_DLL int mn::AddLongLongInt(__int64 packet, long long int add)
{
	int returnMe = 0; 
 ...
 * @copydoc mn::AddUnsignedInt()
 */
DBP_CPP_DLL int mn::AddFloat(__int64 packet, float add)
{
	int returnMe = 0; 
 ...
 * @copydoc mn::AddUnsignedInt()
 */
DBP_CPP_DLL int mn::AddUnsignedByte(__int64 packet, unsigned char add)
{
	int returnMe = 0; 
 ...
 * @copydoc mn::AddUnsignedInt()
 */
CPP_DLL int mn::AddByte(__int64 packet, char add)
{
	int returnMe = 0; 
 ...
 * @copydoc mn::AddUnsignedInt()
 */
CPP_DLL int mn::AddSignedByte(__int64 packet, signed char add)
{
	int returnMe = 0; 
 ...
 * @copydoc mn::AddUnsignedInt()
 */
DBP_CPP_DLL int mn::AddDouble(__int64 packet, double add)
{
	int returnMe = 0; 
 ...
 * @copydoc mn::AddUnsignedInt()
 */
CPP_DLL int mn::AddLongDouble(__int64 packet, long double add)
{
	int returnMe = 0; 
 ...
 * @copydoc mn::AddUnsignedInt()
 */
CPP_DLL int mn::AddShortInt(__int64 packet, short int add)
{
	int returnMe = 0; 
 ...
 * @copydoc mn::AddUnsignedInt()
 */
DBP_CPP_DLL int mn::AddUnsignedShortInt(__int64 packet, unsigned short int add)
{
	int returnMe = 0; 
 ...
 */
DBP_CPP_DLL int mn::AddSizeT(__int64 packet, size_t add)
{
	int returnMe = 0; 
 ...
 */
CPP_DLL int mn::AddUnsignedLongInt(__int64 packet, unsigned long int add)
{
	int returnMe = 0; 
 ...
 * @copydoc mn::AddUnsignedInt()
 */
CPP_DLL int mn::AddUnsignedLongLongInt(__int64 packet, unsigned long long int add)
{
	int returnMe = 0; 
 ...
 * @return	-1 if an error occurred.
 */
DBP_CPP_DLL int mn::AddStringC(__int64 packet, const char * source, size_t length, bool prefix)
{
	int returnMe = 0; 
 ...
 */
DBP_CPP_DLL size_t mn::GetPacketRemainder(__int64 packet)
{
	size_t returnMe = 0; 
 ...
 */
DBP_CPP_DLL unsigned int mn::GetUnsignedInt(__int64 packet)
{
 ...
 */
DBP_CPP_DLL int mn::GetInt(__int64 packet)
{
	int returnMe = -1; 
 ...
 * @copydetails mn::GetUnsignedInt()
 */
CPP_DLL long int mn::GetLongInt(__int64 packet)
{
	long int returnMe = -1; 
 ...
 * @copydetails mn::GetUnsignedInt()
 */
DBP_CPP_DLL long long int mn::GetLongLongInt(__int64 packet)
{
 ...
 * @copydetails mn::GetUnsignedInt()
 */
CPP_DLL float mn::GetFloat(__int64 packet)
{
	float returnMe = -1; 
 ...
 */
DBP_CPP_DLL unsigned char mn::GetUnsignedByte(__int64 packet)
{
 ...
 * @copydetails mn::GetUnsignedInt()
 */
CPP_DLL char mn::GetByte(__int64 packet)
{
	char returnMe = 0; 
 ...
 * @copydetails mn::GetUnsignedInt()
 */
CPP_DLL signed char mn::GetSignedByte(__int64 packet)
{
 ...
 * @copydetails mn::GetUnsignedInt()
 */
DBP_CPP_DLL double mn::GetDouble(__int64 packet)
{
	double returnMe = -1; 
 ...
 * @copydetails mn::GetUnsignedInt()
 */
CPP_DLL long double mn::GetLongDouble(__int64 packet)
{
 ...
 * @copydetails mn::GetUnsignedInt()
 */
CPP_DLL short int mn::GetShortInt(__int64 packet)
{
 ...
 * @copydetails mn::GetUnsignedInt()
 */
DBP_CPP_DLL unsigned short int mn::GetUnsignedShortInt(__int64 packet)
{
 ...
 */
DBP_CPP_DLL size_t mn::GetStringSize(__int64 packet)
{
	size_t returnMe = 0;
 ...
 * @return	-1 if an error occurred.
 */
DBP_CPP_DLL int mn::Encrypt( __int64 packet, __int64 key, bool block )
{
	int returnMe = 0;
 ...
 * @return	-1 if an error occurred.
 */
DBP_CPP_DLL int mn::Decrypt( __int64 packet, __int64 key, bool block )
{
	int returnMe = 0;
 ...
 * @return	-1 if an error occurred.
 */
DBP_CPP_DLL int mn::GetLastEncryptionOperationFinished(__int64 packet)
{
	int returnMe = -1;
 ...
 *
 * @return extracted data. This must be deallocated using delete[] or mn::FreeString.
 * @exception ErrorReport If retrieving data would cause the cursor position to be more than the used size.
  */
CPP_DLL char * mn::GetStringC(__int64 packet, size_t length, bool nullTerminated)
{
	char * returnMe = NULL; 
 ...
 * @exception ErrorReport If retrieving data would cause the cursor position to be more than the used size.
 */
CPP_DLL int mn::GetStringC_B(__int64 packet, char * dest, size_t length, bool nullTerminated)
{
	int returnMe = 0; 
	const char * cCommand = "mn::GetStringC";
 ...
 * @copydetails mn::GetUnsignedInt()
 */
CPP_DLL unsigned long int mn::GetUnsignedLongInt(__int64 packet)
{
 ...
 * @copydetails mn::GetUnsignedInt()
 */
CPP_DLL unsigned long long int mn::GetUnsignedLongLongInt(__int64 packet)
{
 ...
 * @copydetails mn::GetUnsignedInt()
 */
DBP_CPP_DLL size_t mn::GetSizeT(__int64 packet)
{
	size_t returnMe = 0; 
 ...
 */
DBP_CPP_DLL size_t mn::GetAge(__int64 packet)
{
	size_t returnMe = 0; 
 ...
 */
DBP_CPP_DLL size_t mn::GetOperation(__int64 packet)
{
	size_t returnMe = 0;
 ...
 */
DBP_CPP_DLL size_t mn::GetInstance(__int64 packet)
{
	size_t returnMe = 0;
 ...
 *
 */
DBP_CPP_DLL int mn::ClearPacket(__int64 packet)
{
	int returnMe = 0; 
 ...
 * @return	-1 if an error occurred.
 */
DBP_CPP_DLL int mn::AddPacket(__int64 dest, __int64 source)
{
	int returnMe = 0;
 ...
 * @return	-1 if an error occurred.
 */
DBP_CPP_DLL int mn::AssignPacket(__int64 dest, __int64 source)
{
	int returnMe = 0;
	const char * cCommand = "mn::EqualPacket";
 ...
 * @return -1 if an error occurred.
 */
DBP_CPP_DLL int mn::ComparePacket(__int64 packet1, __int64 packet2)
{
	int returnMe = -1;
 ...
 */
DBP_CPP_DLL __int64 mn::CreatePacket()
{
	__int64 returnMe = -1;
 ...
 * @return	-1 if an error occurred.
 */
DBP_CPP_DLL int mn::DeletePacket(__int64 packet)
{
	int returnMe = 0;
 ...
 * @return	-1 if an error occurred.
 */
DBP_CPP_DLL int mn::SetMemorySize(__int64 packet, size_t size)
{
	int returnMe = 0;
 ...
 */
DBP_CPP_DLL size_t mn::GetMemorySize(__int64 packet)
{
	size_t returnMe = 0;
 ...
 * @return	-1 if an error occurred.
 */
DBP_CPP_DLL int mn::SetUsedSize(__int64 packet, size_t size)
{
	int returnMe = 0;
 ...
 */
DBP_CPP_DLL size_t mn::GetUsedSize(__int64 packet)
{
	size_t returnMe = 0;
 ...
 * @return	-1 if an error occurred.
 */
DBP_CPP_DLL int mn::SetCursor(__int64 packet, size_t cursor)
{
	int returnMe = 0;
 ...
 */
DBP_CPP_DLL size_t mn::GetCursor(__int64 packet)
{
	size_t returnMe = 0;
 ...
 * @return	-1 if an error occurred.
 */
DBP_CPP_DLL int mn::Erase(__int64 packet, size_t startPos, size_t amount)
{
	int returnMe = 0;
 ...
 * @return	-1 if an error occurred.
 */
DBP_CPP_DLL int mn::Insert(__int64 packet, size_t amount)
{
	int returnMe = 0;
 ...
 */
DBP_CPP_DLL __int64 mn::CreatePacketFromPacket(__int64 fromPacket)
{
	__int64 returnMe = NULL;
 ...
 */
DBP_CPP_DLL __int64 mn::CreatePacketFromString(const char * str)
{
	__int64 returnMe = NULL;
 ...
 * @return -1 if an error occurred.
 */
DBP_CPP_DLL int mn::ComparePacketString(__int64 packet, const char * str)
{
	int returnMe = -1;
 ...
 * @return	-1 if an error occurred.
 */
DBP_CPP_DLL int mn::ChangeMemorySize(__int64 packet, size_t size)
{
	int returnMe = 0;
 ...
 * @return	-1 if an error occurred.
 */
DBP_CPP_DLL int mn::AssignPacketString(__int64 destination, const char * from)
{
	int returnMe = 0;
 ...
 */
DBP_CPP_DLL bool mn::GetErrorFlag()
{
 ...
 */
DBP_CPP_DLL __int64 mn::CreateKey256(__int64 key1, __int64 key2, __int64 key3, __int64 key4)
{
	__int64 returnMe = 0;
	...
	try
	{
		...
		returnMe = reinterpret_cast<__int64>(keyData);
	}
	STD_CATCH_RM
 ...
 * @return encryption key.
 */
DBP_CPP_DLL __int64 mn::CreateKey192(__int64 key1, __int64 key2, __int64 key3)
{
	__int64 returnMe = 0;
 ...
 * @return encryption key.
 */
DBP_CPP_DLL __int64 mn::CreateKey128(__int64 key1, __int64 key2)
{
	__int64 returnMe = 0;
 ...
 * @return  -1 if an error occurred.
 */
DBP_CPP_DLL int mn::DeleteKey(__int64 Key)
{
	int returnMe = 0; 
 ...
 * @return	byte.
 */
DBP_CPP_DLL DWORD mn::DBP_GetUnsignedByte(__int64 Packet)
{
 ...
 * @return	string.
 */
DBP_CPP_DLL DWORD mn::DBP_GetString(DWORD pOldString, __int64 Packet, size_t Length, bool NullTerminated)
{
	const char * cReturn = GetStringC(Packet,Length,NullTerminated);
 ...
 * @return	string.
 */
DBP_CPP_DLL DWORD mn::DBP_GetFloat(__int64 Packet)
{
 ...
 * @return	string.
 */
DBP_CPP_DLL DWORD mn::DBP_GetProfileLocalIPTCP(DWORD pOldString, __int64 profile)
{
 ...
 * @return	string.
 */
DBP_CPP_DLL DWORD mn::DBP_GetProfileLocalIPUDP(DWORD pOldString, __int64 profile)
{
 ...
 * @return	string.
 */
DBP_CPP_DLL int mn::DBP_GetMemblock(__int64 Packet, size_t DestinationPtr, size_t Length, bool NullTerminated)
{
 ...
 * @return	string.
 */
DBP_CPP_DLL int mn::DBP_AddMemblock(__int64 Packet, size_t DestinationPtr, size_t Length, bool Prefix)
{
...
bool mn::TestClass()
{
	...
	profile.SetModeUDP(NetMode::UDP_PER_CLIENT);
	StartServer(0,50,profile);
	Finish(0);
	Finish(-1);
 ...
 * @return -1 if an error occurred.
 */
DBP_CPP_DLL int mn::GetProfileDecryptKeyLoadedUDP( __int64 profile )
{
	int returnMe = 0;
 ...
 */
DBP_CPP_DLL __int64 mn::GetProfileDecryptKeyUDP(__int64 profile)
{
	__int64 returnMe = -1;
	...
	try
	{
		...
		NetInstanceProfile & ref = PointerConverter::GetRefFromInt<NetInstanceProfile>(profile);
		returnMe = reinterpret_cast<__int64>(ref.GetDecryptKeyUDP());
	}
	STD_CATCH
 ...
 * @return -1 if an error occurred.
 */
DBP_CPP_DLL int mn::SetProfileDecryptKeyUDP(__int64 profile, __int64 key)
{
	int returnMe = 0;
 ...
 * @return -1 if an error occurred.
 */
DBP_CPP_DLL int mn::SetProfileReusableUDP(__int64 profile, bool reusable)
{
	int returnMe = 0;
 ...
 * @return -1 if an error occurred.
 */
DBP_CPP_DLL int mn::GetProfileReusableUDP(__int64 profile)
{
	int returnMe = -1;
 ...
 */
DBP_CPP_DLL size_t mn::GetProfileNumOperationsUDP(__int64 profile)
{
	size_t returnMe = 0;
 ...
 * @return -1 if an error occurred.
 */
DBP_CPP_DLL int mn::SetProfileNumOperationsUDP(__int64 profile, size_t numOperations)
{
	int returnMe = 0;
 ...
 *
 */
CPP_DLL void mn::SetAffixEnableTCP(size_t instanceID, size_t clientID, bool enabledflag)
{
	const char * cCommand = "mn::SetAffixEnableTCP";
	try
	{
		NetInstanceGroup & group = NetUtility::GetInstanceGroup();
		group[instanceID].GetInstanceTCP()->SetAffixEnableTCP(clientID, enabledflag);
	}
	STD_CATCH
}

/**
 * @brief Techlord Modification for TCP_FOR_HTTP Mode. Retrieves the Affix Enabled Flag Value.
 *
 * @return the Affix Flag Value in use.
 */
CPP_DLL bool mn::GetAffixEnableTCP(size_t instanceID, size_t clientID)
{
	int returnMe = -1;
	const char * cCommand = "mn::GetAffixEnableTCP";

	try
	{
		NetInstanceGroup & group = NetUtility::GetInstanceGroup();
		returnMe = group[instanceID].GetInstanceTCP()->GetAffixEnableTCP(clientID);
	}
	STD_CATCH
...
/**
 * @brief Techlord Modification for TCP_FOR_HTTP Mode. Sets HTTP Message Body Response For Binary Mode Transfer.
 *
 */
CPP_DLL void mn::SetBinaryModeTCP(size_t instanceID, size_t clientID, bool enabledflag)
{
	const char * cCommand = "mn::SetBinaryModeTCP";
	try
	{
		NetInstanceGroup & group = NetUtility::GetInstanceGroup();
		group[instanceID].GetInstanceTCP()->SetBinaryModeTCP(clientID, enabledflag);
	}
	STD_CATCH
}
 ...
 * @return the Affix Flag Value in use.
 */
CPP_DLL bool mn::GetBinaryModeTCP(size_t instanceID, size_t clientID)
{
	int returnMe = -1;
	const char * cCommand = "mn::GetBinaryModeTCP";

	try
	{
		NetInstanceGroup & group = NetUtility::GetInstanceGroup();
		returnMe = group[instanceID].GetInstanceTCP()->GetBinaryModeTCP(clientID);
	}
	STD_CATCH
...
/**
 * @brief Techlord Modification for TCP_FOR_HTTP Mode. Set Header Found Flag.
 *
 */
CPP_DLL void mn::SetHeaderFoundTCP(size_t instanceID, size_t clientID, bool foundflag)
{
	const char * cCommand = "mn::SetHeaderFoundTCP";
	try
	{
		NetInstanceGroup & group = NetUtility::GetInstanceGroup();
		group[instanceID].GetInstanceTCP()->SetHeaderFoundTCP(clientID, foundflag);
	}
	STD_CATCH
}
 ...
 * @return the Affix Flag Value in use.
 */
CPP_DLL bool mn::GetHeaderFoundTCP(size_t instanceID, size_t clientID)
{
	int returnMe = -1;
	const char * cCommand = "mn::GetHeaderFoundTCP";

	try
	{
		NetInstanceGroup & group = NetUtility::GetInstanceGroup();
		returnMe = group[instanceID].GetInstanceTCP()->GetHeaderFoundTCP(clientID);
	}
	STD_CATCH
