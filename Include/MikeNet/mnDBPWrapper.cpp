...
#include <conio.h>
#ifdef DBP
	char * mnGetStringC(__int64 Packet, size_t iLength, bool bNullTerminated);
	int mnGetStringC(__int64 Packet, char * Destination, size_t iLength, bool bNullTerminated);
