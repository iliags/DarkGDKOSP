 ...
 *
 * @return a pointer (cast to an __int64) to a SoundFormat object. 
 */
DBP_CPP_DLL __int64 mnSound::CreateSoundProfile()
{
	...
	try
	{
		...
		returnMe = reinterpret_cast<__int64>(profile);
	}
	STD_CATCH
 ...
 * @return	-1 if an error occurred.
 */
DBP_CPP_DLL int mnSound::DeleteSoundProfile(__int64 profile)
{
 ...
 * @return	-1 if an error occurred.
 */
DBP_CPP_DLL int mnSound::SetSoundProfile(__int64 profile, DWORD khz, WORD bitsPerSample, WORD channels)
{
 ...
 * @return	-1 if an error occurred.
 */
DBP_CPP_DLL int mnSound::SetSoundProfileHighQuality(__int64 profile)
{
 ...
 * @return	-1 if an error occurred.
 */
DBP_CPP_DLL int mnSound::SetSoundProfileMediumQuality(__int64 profile)
{
 ...
 * @return	-1 if an error occurred.
 */
DBP_CPP_DLL int mnSound::SetSoundProfileLowQuality(__int64 profile)
{
 ...
 */
DBP_CPP_DLL	WORD mnSound::GetSoundProfileChannels(__int64 profile)
{
 ...
 */
DBP_CPP_DLL DWORD mnSound::GetSoundProfileSamplesPerSecond(__int64 profile)
{
 ...
 */
DBP_CPP_DLL WORD mnSound::GetSoundProfileBitsPerSample(__int64 profile)
{
 ...
 * @return	-1 if an error occurred.
 */
DBP_CPP_DLL int mnSound::StartInput(size_t instanceID, unsigned int inputDeviceID, size_t numBuffers, size_t buffTimeLength, __int64 soundFormat)
{
	const char * cCommand = "mnSound::StartInput";
	int returnMe = 0;
 ...
 */
DBP_CPP_DLL size_t mnSound::GetInputData( size_t instanceID, __int64 destination )
{
	const char * cCommand = "mnSound::GetInputData";
	size_t returnMe = 0;
...
int mnSound::StartOutput(size_t instanceID, unsigned int outputDeviceID, size_t msStoredDataCap, size_t timeGapCap, const SoundFormat & soundFormat)
{
	...
	try
	{
		SoundInstanceOutput * instance = new (nothrow) SoundInstanceOutput(msStoredDataCap,timeGapCap,soundFormat,outputDeviceID);
		Utility::DynamicAllocCheck(instance,__LINE__,__FILE__);
 ...
 * @return	-1 if an error occurred.
 */
DBP_CPP_DLL int mnSound::StartOutput(size_t instanceID, unsigned int outputDeviceID, size_t msStoredDataCap, size_t timeGapCap, __int64 soundFormat)
{
	const char * cCommand = "mnSound::StartOutput";
	int returnMe = 0;
 ...
 * @return	-1 if an error occurred.
 */
DBP_CPP_DLL int mnSound::PlayData(size_t instanceID, __int64 packet)
{
	const char * cCommand = "mnSound::PlayData";
	int returnMe = 0;
...
DBP_CPP_DLL int mnSound::SetOutputSmoothValues(size_t instanceID, size_t msStoredDataCap, size_t timeGapCap)
{
	...
	try
	{
		SoundUtility::GetOutputInstance(instanceID)->SetSmoothValues(msStoredDataCap,timeGapCap);
	}
	STD_CATCH_RM
 ...
 */
int mnSound::SetDataVolume(unsigned short bitsPerSample, Packet * dataPacket, double percentageChange)
{
 ...
 * @return -1 if an error occurred.
 */
DBP_CPP_DLL int mnSound::SetDataVolume(WORD bitsPerSample, __int64 dataPacket, double percentageChange)
{
	const char * cCommand = "mnSound::SetDataVolume";
	int returnMe = 0;
 ...
 * @return	the volume of the data. If 16 bit then the range is 0 to 65535. If 8 bit then the range is 0 to 255.
 */
DBP_CPP_DLL int mnSound::GetDataVolume(WORD bitsPerSample, __int64 dataPacket)
{
	const char * cCommand = "mnSound::GetDataVolume";
	int returnMe = 0;
