...
void ComputeParticles()
{
    ...
    P.Source(25, PDLine(pVec(0, 0, 0), pVec(0, 0, 0.4f)));
...
void DrawGroupAsPoints()
{
	...
	for(size_t loop=0;loop<cnt;loop++){
		...
		float *age = nextptr + age1Ofs;
		
		D3DVECTOR position = {*(nextptr + pos3Ofs), *(nextptr + pos3Ofs + 1), *(nextptr + pos3Ofs + 2)}; 
