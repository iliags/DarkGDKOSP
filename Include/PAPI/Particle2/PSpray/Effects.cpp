...
#include "..\..\DMcTools\Image\ImageAlgorithms.h"

/*//Removed GL references Techlord 02/01/11
#ifndef NO_OGL_OBSTACLES
// This is for drawing the obstacles for Shower().
#include "..\..\Goodies\include\GL\glut.h"
#endif
*/
...
/*
ParticleEffects::ParticleEffects(void) : P(P_)
{
    maxParticles = 0;
    numSteps = 0;
    particle_handle = -1;
    ...
    EffectName = "NoEffect";
    Img = NULL;
    GravityVec = pVec(0.0f, 0.0f, 0.0f);
}
*/
