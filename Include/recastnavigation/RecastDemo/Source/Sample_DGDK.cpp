...
// SAMPLE_DGDK (SoloMeshSimple) ////////////////////////////////////////////////////////////////////////////////////////////////////

Sample_DGDK::Sample_DGDK() :
...
void Sample_DGDK::handleSettings()
{
/*
...
void Sample_DGDK::handleDebugMode()
{
/*
...
void Sample_DGDK::handleRenderOverlay(double* proj, double* model, int* view)
{
/*
	if (m_tool)
...
void Sample_DGDK::handleMeshChanged(class InputGeom* geom)
{
