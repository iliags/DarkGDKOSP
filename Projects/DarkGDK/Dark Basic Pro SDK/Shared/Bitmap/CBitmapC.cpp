...
DARKSDK LPDIRECT3DSURFACE9 CreateBitmap ( int iID, int iWidth, int iHeight )
{
	temp = 0;
...
LPDIRECT3DSURFACE9 dbCreateBitmap ( int iID, int iWidth, int iHeight )
{
