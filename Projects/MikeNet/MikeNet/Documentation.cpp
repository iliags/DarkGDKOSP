 ...
 * be plugged into other classes such as NetSocketUDP or NetInstanceServer. This makes MikeNet very flexible, and means that it can be easily modified to fulfill
 * any networking requirement.
 *
 * At higher levels you have namespace filled with easy to use commands built for usage in a procedural manner. These commands can be found in @link mn networking@endlink, @link mnSound sound@endlink and @link mnNAT UPnP NAT@endlink sections and are
