...
public:	
	...
	NetInstanceBroadcast(const NetAddress * broadcastAddress, NetSocketUDP * socketUDP, unsigned int sendTimeout = INFINITE, size_t instanceID = 0);
	NetInstanceBroadcast(const NetAddress * broadcastAddress, const NetInstanceProfile & profile, size_t instanceID = 0);
