 ...
 */
ThreadSingle::ThreadSingle(LPTHREAD_START_ROUTINE function, void * parameter, bool suspended, size_t manualThreadID)
{
...
bool ThreadSingle::TestClass()
{
...

	{
		...
		Utility::output.Leave();
		ThreadSingle thread(&ThreadSingleTestFunction,(void*)5000,false,9999);
