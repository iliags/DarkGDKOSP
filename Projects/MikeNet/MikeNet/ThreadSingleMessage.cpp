 ...
 */
ThreadSingleMessage::ThreadSingleMessage(LPTHREAD_START_ROUTINE function, void * parameter, bool suspended, size_t manualThreadID) : threadReady(false), ThreadSingle(function,parameter,suspended,manualThreadID)
{
}
...
bool ThreadSingleMessage::TestClass()
{
	...
	{
		ThreadSingleMessage thread(&ThreadSingleMessageTestFunction,NULL,false);
