 ...
 */
ThreadSingleMessageKeepLast::ThreadSingleMessageKeepLast(LPTHREAD_START_ROUTINE function, void * parameter, bool suspended, size_t manualThreadID)
	: ThreadSingleMessage(function, parameter, suspended, manualThreadID)
{
	lastMessage = NULL;
}
